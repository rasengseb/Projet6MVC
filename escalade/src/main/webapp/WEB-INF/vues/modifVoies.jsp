...
<div class="container">
    <div class="card">
        <h1 class="card-header">Modifier voie :</h1>
        <div class="card-body">
            <form:form action="/voie/updateVoie/${voie.secteur.id}" cssClass="form-horizontal" method="post" modelAttribute="voie">
                <form:hidden path="id"/>
